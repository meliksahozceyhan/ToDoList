...
public class ToDoListDB {
    ...
    public static String CREATE_TABLE_SQL="CREATE TABLE TABLE_NAME ( "+FIELD_ID+" INTEGER, "+FIELD_NAME+" TEXT, "+FIELD_NOTE+" TEXT, "+FIELD_DATE+" TEXT,"+FIELD_ITEMS+" TEXT,"
    ...
    public static boolean insert(DatabaseHelper dbHelper, String id, String name, String note,String createdAt,String items) {
